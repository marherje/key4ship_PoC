...
gun_direction = (1, 0, 0)
gun_position = (-1000 * mm, 0.1 * mm, 0.1 * mm)
...
SIM.outputFile     = os.path.abspath("/afs/cern.ch/user/m/marquezh/public/key4ship/key4ship_PoC/simulation/run_script/data/output_mu-_xyz_-1000_0.1_0.1_E50.edm4hep.root")
