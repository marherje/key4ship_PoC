...
for physlist in ${physl[@]}; do
    ...
    label=${physlist}_SND_${particle}_${energy}GeV_xyz_${pos_x}_${pos_y}_${pos_z}
...
SIM.outputFile     = os.path.abspath("${data_path}/output_${particle}_xyz_${pos_x}_${pos_y}_${pos_z}_E${energy}.edm4hep.root")
