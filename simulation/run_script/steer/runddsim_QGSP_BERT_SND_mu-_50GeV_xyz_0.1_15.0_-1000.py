...
gun_direction = (0, 0, 1)
gun_position = (0.1 * mm, 15.0 * mm, -1000 * mm)
...
SIM.outputFile     = os.path.abspath("/afs/cern.ch/user/m/marquezh/public/key4ship/key4ship_PoC/simulation/run_script/data/output_mu-_xyz_0.1_15.0_-1000_E50.edm4hep.root")
