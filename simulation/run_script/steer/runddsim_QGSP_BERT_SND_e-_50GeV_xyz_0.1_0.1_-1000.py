...
SIM.outputFile     = os.path.abspath("/afs/cern.ch/user/m/marquezh/public/key4ship/key4ship_PoC/simulation/run_script/data/output_e-_xyz_0.1_0.1_-1000_E50.edm4hep.root")
