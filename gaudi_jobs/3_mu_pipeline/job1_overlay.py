...
overlay.SourceIDs           = [1, 2, 3]
overlay.CollectionsSiTarget = ['SiTargetHits', 'SiTargetHits', 'SiTargetHits']
overlay.CollectionsSiPad    = ['SiPadHits', 'SiPadHits', 'SiPadHits']
overlay.CollectionsMTC      = ['MTCDetHits', 'MTCDetHits', 'MTCDetHits']
